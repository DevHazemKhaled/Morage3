    ...
    lessons: [
        {
            ...
            content: `
                ...
                <p>الكمبيوتر يفهم لغة واحدة فقط: لغة الآلة، والتي تتكون من 0 و 1 فقط. كل شيء نراه على الشاشة هو في النهاية ترجمة لهذه الأصفار والواحدات.</p>
...
01000001
                ...
                <ul>
                    ...
                    <li><strong>المدخلات والمخرجات (I/O):</strong> لوحة المفاتيح، الشاشة، الماوس، وغيرها</li>
                </ul>
...
// الناتج: مرحباً أحمد
                ...
                <h4>أنظمة الأعداد في الكمبيوتر</h4>
                <p>الكمبيوتر يستخدم أنظمة أعداد مختلفة:</p>
                <ul>
                    <li><strong>النظام الثنائي (Binary):</strong> يتكون من 0 و 1 فقط</li>
                    <li><strong>النظام الثماني (Octal):</strong> يتكون من 0 إلى 7</li>
                    <li><strong>النظام العشري (Decimal):</strong> نظامنا اليومي من 0 إلى 9</li>
                    <li><strong>النظام السداسي عشري (Hexadecimal):</strong> من 0 إلى 9 و A إلى F</li>
                </ul>
            `
        },
        {
            ...
            content: `
                ...
                <div class="example-box">
                    ...
                    <p>متوسط رواتب المبرمجين في العالم يتراوح بين 70,000 إلى 150,000 دولار سنوياً، مع فرص نمو كبيرة.</p>
                </div>
                
                <h4>مستقبل البرمجة</h4>
                <p>البرمجة ستظل مهارة أساسية في المستقبل. مع تطور الذكاء الاصطناعي، ستتغير طبيعة البرمجة ولكن لن تختفي. المبرمجون سيصبحون أكثر تخصصاً في حل المشكلات المعقدة.</p>
            `
        },
        {
            id: '1-3',
...
console.log(result); // الناتج: 9
                ...
                <h4>أنواع الخوارزميات</h4>
                <ul>
                    <li><strong>خوارزميات البحث:</strong> مثل البحث الثنائي والخطي</li>
                    <li><strong>خوارزميات الترتيب:</strong> مثل الترتيب الفقاعي والسريع</li>
                    <li><strong>خوارزميات التشفير:</strong> مثل AES و RSA</li>
                    <li><strong>خوارزميات الذكاء الاصطناعي:</strong> مثل الشبكات العصبية</li>
                </ul>
...
fetch('https://api.example.com/data')
    ...
    .then(data => console.log(data));
                ...
                <h4>بروتوكولات الإنترنت المهمة</h4>
                <ul>
                    <li><strong>HTTP/HTTPS:</strong> بروتوكول نقل النص التشعبي</li>
                    <li><strong>FTP:</strong> بروتوكول نقل الملفات</li>
                    <li><strong>TCP/IP:</strong> بروتوكول التحكم في النقل</li>
                    <li><strong>SMTP:</strong> بروتوكول نقل البريد</li>
                </ul>
            `
        },
        {
...
public class Hello {
    public static void main(String[] args) {
        ...
        System.out.println(message);
                ...
                <h4>كيف تختار لغة البرمجة المناسبة؟</h4>
                <ul>
                    <li>حدد هدفك: ماذا تريد أن تبني؟</li>
                    <li>ابحث عن فرص العمل في مجالك</li>
                    <li>تعلم لغة واحدة جيداً قبل الانتقال للأخرى</li>
                    <li>لا تتشتت بين اللغات في البداية</li>
                </ul>
            `
        }
    ]
